    ...
    <table id="tblResult" class="display">
        ...
        <tbody>
            <% 
                ...
                var deleteTemplate = Html.ActionLinkWithRoles<OAMS.Controllers.ProductController>("Delete", r => r.Delete(0), new RouteValueDictionary(new { id = "productID" }), new Dictionary<string, object>() { { "onclick", "return confirm('Sure?');" } }, false);
            %>
